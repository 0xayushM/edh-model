...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full text-foreground pt-10 pb-5 px-10 font-sans " >
      <div className="w-4/5 mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        <div className="md:text-right pt-0 md:mt-[30px]">
          <div className="mb-6">
            <h4 className="text-sm uppercase archimoto-bold tracking-[0.2em] text-gray-500 mb-2">Email</h4>
            <a href={`mailto:${company.contact.email}`} className="text-lg transition-colors archimoto-bold button-wipe-hover duration-300" data-text={company.contact.email}>{company.contact.email}</a>
          </div>
          <div>
            <h4 className="text-sm uppercase archimoto-bold tracking-[0.2em] text-gray-500 mb-2">Phone</h4>
            <a href={`tel:${company.contact.phone}`} className="text-lg transition-colors archimoto-bold button-wipe-hover duration-300" data-text={company.contact.phone}>{company.contact.phone}</a>
          </div>
        </div>

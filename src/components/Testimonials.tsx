...
const Testimonials: React.FC = () => {
  ...
  return (
    <section id="testimonials" className="min-h-screen bg-gradient-to-b from-black/80 via-black/80 to-background/80 backdrop-blur-md flex flex-col items-center justify-center">

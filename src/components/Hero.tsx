  ...
  return (
    <>
      ...
      <div id='home' className='relative overflow-hidden w-full h-screen flex flex-col md:flex-row items-center justify-between'>
        ...
        <div className='relative z-10 md:h-screen pt-24 md:pt-48 w-full bg-black/50 flex flex-col bg-black/50 px-4 md:pl-24 md:pr-12'>
        ...
        <div className='relative z-10 md:h-screen pb-12 md:pb-48 w-full flex flex-col-reverse bg-black/50 px-4 md:pr-24 md:pl-12'>

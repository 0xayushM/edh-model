...
export const P3 = new THREE.Vector3(-0.7, -0.75, 1.3);
export const P4 = new THREE.Vector3(0.6, -0.4, 1.3);
export const P5 = new THREE.Vector3(-0.8, 0.2, 1.5);
...
export const Q_initial = new THREE.Quaternion().setFromEuler(new THREE.Euler(deg(180), deg(0), 0, "YXZ"));
